...
const Home = () => {
  ...
  return (
    <div className="relative">
      <Helmet>
        <title>
          ZenkaiDrive | Watch Anime Online - Free Anime Streaming in HD
        </title>
        <meta
          name="description"
          content="ZenkaiDrive is your ultimate destination for free anime streaming. Watch anime online with SUB and DUB in stunning HD quality."
        />
        <meta property="og:title" content="ZenkaiDrive - Modern Anime Streaming" />
      </Helmet>
      {isLoading ? (
